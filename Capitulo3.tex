...
\begin{table}
    ...
    \begin{tabular}{|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{2cm}|}
        ...
        \textbf{Ero} & Salta & El Rosal & -24.39278 & -65.76806 & 3355& \textbf{Bsk}\\
...
\begin{figure*}
    ...
    \caption[Coeficientes de correlación de Pearson y Spearman entre las variables meteorológicas y las distintas metodologías.]{Coeficientes de correlación de Pearson y Spearman entre las variables meteorológicas y las distintas metodologías (Yu, Sa, Sca, Ero y Lq).}
