...
En esta sección se evalúa el impacto de considerar la estacionalidad en la serie GHI sobre el proceso de AS, comparando el enfoque tradicional, que no realiza ajustes, con la metodología propuesta de desestacionalización. Los resultados obtenidos ofrecen una visión más clara de cómo la estacionalidad puede influir en la adaptación al sitio y destacan la importancia de integrar este paso en los procedimientos de análisis de series temporales en meteorología y energía solar.
